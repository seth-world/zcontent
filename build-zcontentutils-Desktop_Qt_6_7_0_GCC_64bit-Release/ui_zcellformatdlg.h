...
public:
    ...
    void setupUi(QDialog *ZCellFormatDLg)
    {
        ...
        NumericGBx->setGeometry(QRect(10, 100, 351, 81));
        ...
        ResourceGBx->setGeometry(QRect(10, 350, 351, 81));
        ...
        OKBTn->setGeometry(QRect(280, 440, 80, 23));
        DateGBx = new QGroupBox(ZCellFormatDLg);
        DateGBx->setObjectName("DateGBx");
        DateGBx->setGeometry(QRect(10, 180, 351, 161));
        ...
        PrefixCBx = new QCheckBox(ZCellFormatDLg);
        PrefixCBx->setObjectName("PrefixCBx");
        PrefixCBx->setGeometry(QRect(10, 70, 281, 20));
    ...
    void retranslateUi(QDialog *ZCellFormatDLg)
    {
        ...
        PrefixCBx->setText(QCoreApplication::translate("ZCellFormatDLg", "Prefix displayed value with explicit ZType name", nullptr));
    } // retranslateUi
