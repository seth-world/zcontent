...
public:
    ...
    void setupUi(QDialog *ZRawMasterFileVisu)
    {
        if (ZRawMasterFileVisu->objectName().isEmpty())
            ZRawMasterFileVisu->setObjectName("ZRawMasterFileVisu");
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8("../../zqt/icons/backward.gif"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8("../../zqt/icons/forward.gif"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8("../../zqt/icons/tobegin.gif"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        BeginBTn->setIcon(icon2);
        EndBTn = new QPushButton(groupBox);
        EndBTn->setObjectName("EndBTn");
        EndBTn->setGeometry(QRect(610, 40, 31, 23));
        QIcon icon3;
        icon3.addFile(QString::fromUtf8("../../zqt/icons/toend.gif"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        BottomLBl->setObjectName("BottomLBl");
