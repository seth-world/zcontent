...
public:
    ...
    void setupUi(QMainWindow *ZContentVisuMain)
    {
        ...
        RecordFRm->setObjectName("RecordFRm");
        ...
        RecordNumberLBl->setObjectName("RecordNumberLBl");
        ...
        BlockSizeLBl->setObjectName("BlockSizeLBl");
        ...
        UserSizeLBl->setObjectName("UserSizeLBl");
        ...
        LockMaskLBl->setObjectName("LockMaskLBl");
        LockMaskLBl->setGeometry(QRect(300, 50, 121, 16));
        RecordTotalLBl = new QLabel(RecordFRm);
        RecordTotalLBl->setObjectName("RecordTotalLBl");
        ...
        LoadAllBTn->setObjectName("LoadAllBTn");
        ...
        SequentialFRm->setObjectName("SequentialFRm");
        ...
        ReadSizeLBl->setObjectName("ReadSizeLBl");
        ...
        FullSizeLBl->setObjectName("FullSizeLBl");
        ...
        ZRFVersionLBl->setObjectName("ZRFVersionLBl");
        ZRFVersionLBl->setGeometry(QRect(240, 170, 101, 16));
        ZMFVersionLBl = new QLabel(MainFRm);
        ZMFVersionLBl->setObjectName("ZMFVersionLBl");
        ...
        searchTypeCBx->setObjectName("searchTypeCBx");
        ...
        searchFwdBTn->setObjectName("searchFwdBTn");
        ...
        fileMEn->setObjectName("fileMEn");
        ZRFMEn = new QMenu(menubar);
        ZRFMEn->setObjectName("ZRFMEn");
        ZMFMEn = new QMenu(menubar);
        ZMFMEn->setObjectName("ZMFMEn");
        menurepair_all_indexes = new QMenu(ZMFMEn);
        menurepair_all_indexes->setObjectName("menurepair_all_indexes");
        rawMEn = new QMenu(menubar);
        rawMEn->setObjectName("rawMEn");
        headerMEn = new QMenu(menubar);
        headerMEn->setObjectName("headerMEn");
        menuView_pool = new QMenu(headerMEn);
        menuView_pool->setObjectName("menuView_pool");
        ...
        ZContentVisuMain->addToolBar(Qt::ToolBarArea::TopToolBarArea, toolBar);
