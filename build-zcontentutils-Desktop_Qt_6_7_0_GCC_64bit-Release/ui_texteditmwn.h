...
public:
    ...
    void setupUi(QMainWindow *textEditMWn)
    {
        if (textEditMWn->objectName().isEmpty())
            textEditMWn->setObjectName("textEditMWn");
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8("../../zqt/icons/magnifyingglass.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8("../../zqt/icons/strigi.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8("../../zqt/icons/funel.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
