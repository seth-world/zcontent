...
//    QList<QStandardItem*> createDomainRow(ZDomainPath* pDomain);  // changed to routine createZDomainSingleRow out of object
...
public:
    /*
    static QIcon MainDomainICn;
    static QIcon DomainICn;

    static ZFakeBTn           ToolTipZFb;
    static ZFakeBTn           ViewZFb;
    static ZFakeBTn           EditZFb;
    static ZFakeBTn           HierarchyZFb;
*/
...
inline static ZFakeBTn           ToolTipZFb;
inline static ZFakeBTn           ViewZFb;
inline static ZFakeBTn           EditZFb;
inline static ZFakeBTn           HierarchyZFb;
...
void erroredViewer( QWidget* pFather,ZaiErrors* pErrorLog);
