...
struct qt_meta_stringdata_zbs__KeyField_Pack_t {
    QByteArrayData data[1];
    char stringdata0[19];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_zbs__KeyField_Pack_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_zbs__KeyField_Pack_t qt_meta_stringdata_zbs__KeyField_Pack = {
    {
QT_MOC_LITERAL(0, 0, 18) // "zbs::KeyField_Pack"
...
static const uint qt_meta_data_zbs__KeyField_Pack[] = {
...
QT_INIT_METAOBJECT const QMetaObject zbs::KeyField_Pack::staticMetaObject = { {
    QMetaObject::SuperData::link<FieldDesc_Pack::staticMetaObject>(),
    qt_meta_stringdata_zbs__KeyField_Pack.data,
    qt_meta_data_zbs__KeyField_Pack,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *zbs::KeyField_Pack::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_zbs__KeyField_Pack.stringdata0))
