 ...
 */
int
ZSKeyExtractCompareBinary (ZDataBuffer &pKey,ZDataBuffer &pRecord,ZSKeyDictionary *pZKDic)
{
    ZDataBuffer pKey2;
...
int
ZSKeyExtractCompareAlpha (const ZDataBuffer &pKey,ZDataBuffer &pRecord,ZSKeyDictionary *pZKDic)
{
    ZDataBuffer pKey2;
    return (strncmp(pKey.DataChar,_keyValueExtraction(*pZKDic,pRecord,pKey2).DataChar,pKey.Size));
}

typedef int  (*ZIFExtractCompare) (const ZDataBuffer &pKey,const ZDataBuffer &pKey2,ZSKeyDictionary *pZKDic);

ZStatus _keyValueExtraction(ZSKeyDictionary &pZKDic, ZDataBuffer &pContent, ZDataBuffer& pKey);


static inline
ZResult
_seekZSIFGeneric(const ZDataBuffer &pKey, ZRandomFile &pZRF,ZSIndexControlBlock* pZICB,ZIFCompare pZIFCompare)
{
