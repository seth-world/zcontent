...
{
    ZSMCBOwnData_Export* wMCBe = (ZSMCBOwnData_Export*)ZReserved.Data;
...
ZStatus
ZRawMasterFile::zcreateRawIndex ( ZIndexFile *&pIndexObjectOut,
 ...
 */
ZStatus
ZRawMasterFile::zreorgRawFile (bool pDump,FILE *pOutput)
{
ZStatus wSt;
long wi = 0;
