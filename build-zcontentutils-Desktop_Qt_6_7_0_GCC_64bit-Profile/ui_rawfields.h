...
public:
    ...
    void setupUi(QMainWindow *RawFields)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8("../../zqt/icons/gearing.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8("../../zqt/icons/leftarrowbluelight.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
