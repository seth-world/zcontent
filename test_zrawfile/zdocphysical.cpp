/**  This file has been generated by zcontent utilities generator version 1.0-1
 ...
 Generation date 2022-12-02 11:51:15
...
/*              move of individual fields to record space */
 ...
 utf8VaryingString ZDocPhysical::getKey1_Name() {
   return "Secondary key duplicates";
 }
 ...
 utf8VaryingString ZDocPhysical::getKey2_Name() {
   return "Third key duplicates";
 }
 ZDataBuffer ZDocPhysical::getKey2() {
   ZDataBuffer wReturn;
   /* export class using embedded URF export routine */
   Registrated._exportURF(wReturn);
   /* export class using embedded URF export routine */
   LastModified._exportURF(wReturn);
   return wReturn;
 } // getKey2 
   ZDataBuffer ZDocPhysical::getKey(long pKeyNumber) {
     switch (pKeyNumber) {
       ...
       case 2 :
         return getKey2();
       default :
         fprintf(stderr,"ZDocPhysical::getKey-E-INVVALUE Invalid key number <%ld> while expected [0,2].\n",pKeyNumber);
         return ZDataBuffer();
     } // switch
   } // getKey
