...
#ifndef ZDOCPHYONEKEY_H
#define ZDOCPHYONEKEY_H
...
/** @brief ZDocPhyOneKey Physical document two keys */
...
public:
    ...
    ZResource Vaultid;
/* Public methods */
   ZDocPhyOneKey()=default;
   ZDocPhyOneKey& _copyFrom(const ZDocPhyOneKey& pIn);
   ZDocPhyOneKey& operator = (const ZDocPhyOneKey& pIn) { return _copyFrom(pIn); }
   void clear();
