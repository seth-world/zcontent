/**  This file has been generated by zcontent utilities generator version 1.0-1
 ...
 Generation date 2023-03-27 16:32:28
...
/*              move of individual fields to record space */
 ...
 ZStatus ZDocPhyOneKey::fromRecord(const ZDataBuffer& pRecord) { 
   ...
   if ((wPtr + sizeof(uint64_t)) >= wPtrEnd) {
     fprintf(stderr, "ZDocPhyOneKey::fromRecord-F-OUTBOUND Out of input boundaries while getting field <wURFSize>.\n");
     return ZS_OUTBOUND;
   }
   ...
   ZDataBuffer ZDocPhyOneKey::getKey(long pKeyNumber) {
     switch (pKeyNumber) {
       case 0 :
         return getKey0();
       default :
         fprintf(stderr,"ZDocPhyOneKey::getKey-E-INVVALUE Invalid key number <%ld> while expected [0,0].\n",pKeyNumber);
         return ZDataBuffer();
     } // switch
   } // getKey
