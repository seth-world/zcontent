...
public:
    ...
    void setupUi(QDialog *ZExceptionDLg)
    {
        if (ZExceptionDLg->objectName().isEmpty())
            ZExceptionDLg->setObjectName("ZExceptionDLg");
        ...
        dontShowCKb->setObjectName("dontShowCKb");
        ...
        ErrlogBTn->setObjectName("ErrlogBTn");
        ...
        OtherBTn->setObjectName("OtherBTn");
        ...
        ExceptionFRm->setObjectName("ExceptionFRm");
        ...
        ZStatusLBl->setObjectName("ZStatusLBl");
        ...
        VertLayoutMsgVLy_2->setObjectName("VertLayoutMsgVLy_2");
        ...
        MessageTEd->setObjectName("MessageTEd");
