...
public:
    ...
    void setupUi(QDialog *ZFieldDLg)
    {
        if (ZFieldDLg->objectName().isEmpty())
            ZFieldDLg->setObjectName("ZFieldDLg");
        ...
        FieldNameLEd->setObjectName("FieldNameLEd");
