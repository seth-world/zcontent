...
enum ZDomain_enum : ZDomain_type
{
    ...
    ZDOM_TextFile   =     0x001000,
    ZDOM_HtmlFile   =     0x002000,
    ZDOM_PdfFile    =     0x004000,

    ZDOM_OdfFile    =     0x008000,

    ZDOM_XmlFile    =     0x010000,

    ZDOM_MasterFile =   0x01000000,
    ZDOM_HeaderFile =   0x03000000,

    ZDOM_Other      =  0x100000000,

    ZDOM_Font       =  0x200000000,

    ZDOM_ObjectMask = 0xFFFFFFFF00,
...
struct TypeDecodeStruct
{
    ...
    const utf8VaryingString     DisplayName ;
};
